...
$defaultCropSettings = [
    ...
    'allowedAspectRatios' => [
        ...
        '3:4' => [
            'title' => 'LLL:EXT:npt3basic/Resources/Private/Language/Backend.xlf:ratio.3_4',
            'value' => 3 / 4
        ],
        '2:1' => [
            'title' => 'LLL:EXT:npt3basic/Resources/Private/Language/Backend.xlf:ratio.2_1',
            'value' => 2 / 1
        ],
        '1:2' => [
            'title' => 'LLL:EXT:npt3basic/Resources/Private/Language/Backend.xlf:ratio.1_2',
            'value' => 1 / 2
        ],
        '1:1' => [
...
$extralargeCropSettings = $defaultCropSettings;
$extralargeCropSettings['title'] = 'LLL:EXT:npt3basic/Resources/Private/Language/Backend.xlf:option.extralarge';
...
$GLOBALS['TCA']['tt_content']['columns']['background_image']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tt_content']['types']['image']['columnsOverrides']['image']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tt_content']['types']['textpic']['columnsOverrides']['image']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tt_content']['types']['media']['columnsOverrides']['assets']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tt_content']['types']['textmedia']['columnsOverrides']['assets']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tx_bootstrappackage_card_group_item']['types']['1']['columnsOverrides']['image']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tx_bootstrappackage_accordion_item']['types']['1']['columnsOverrides']['media']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tx_bootstrappackage_carousel_item']['columns']['background_image']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tx_bootstrappackage_carousel_item']['columns']['image']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tx_bootstrappackage_tab_item']['types']['1']['columnsOverrides']['media']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
$GLOBALS['TCA']['tx_bootstrappackage_timeline_item']['types']['1']['columnsOverrides']['image']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
...
foreach ([1, 3, 4] as $type) {
    ...
    $GLOBALS['TCA']['pages']['types'][$type]['columnsOverrides']['thumbnail']['config']['overrideChildTca']['columns']['crop']['config']['cropVariants']['extralarge'] = $extralargeCropSettings;
